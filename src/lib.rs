...
#[init(contract = "concordium_multisig_contract")]
...
#[receive(
    contract = "concordium_multisig_contract",
    name = "receive",
...
#[receive(contract = "concordium_multisig_contract", name = "view", return_value = "State")]
